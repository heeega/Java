...
public class ComponentsTset {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ComponentsTset window = new ComponentsTset();
	...
	private void initialize() {
		...
		lblNewLabel_4.setBounds(12, 153, 57, 15);
		...
		JLabel lblNewLabel_5 = new JLabel("휴대폰");
		lblNewLabel_5.setBounds(12, 182, 57, 15);
		...
		lbResultHp.setHorizontalAlignment(SwingConstants.LEFT);
		lbResultHp.setBounds(247, 182, 115, 15);
		frame.getContentPane().add(lbResultHp);
		
		JLabel lblNewLabel_7 = new JLabel("덧셈");
		lblNewLabel_7.setBounds(12, 215, 57, 15);
		...
		lblNewLabel_9.setBounds(110, 210, 13, 23);
		...
		lblNewLabel_11.setBounds(110, 240, 13, 23);
		...
		JLabel lblNewLabel_12 = new JLabel("뺄셈");
		lblNewLabel_12.setBounds(12, 245, 57, 15);
		...
		lblNewLabel_14.setBounds(110, 270, 13, 23);
		...
		JLabel lblNewLabel_15 = new JLabel("곱셈");
		lblNewLabel_15.setBounds(12, 275, 57, 15);
		...
		lblNewLabel_17.setBounds(110, 300, 13, 23);
		...
		JLabel lblNewLabel_18 = new JLabel("나눗셈");
		lblNewLabel_18.setBounds(12, 305, 57, 15);
		frame.getContentPane().add(lblNewLabel_18);
		
		JLabel lblNewLabel_19 = new JLabel("체크박스 실습");
		lblNewLabel_19.setBounds(12, 347, 93, 15);
		...
		btnDiv.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lbResultDiv.setText("결과 : " + result4);
			}
		});
