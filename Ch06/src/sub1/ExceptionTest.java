...
public class ExceptionTest {
	public static void main(String[] args) {
		...
		// 예외상황 1. 어떤 수를 0으로 나눌때(Arithmetic Exception)
		int num1=1;
		int num2=0;
		...
		// 예외상황2. 배열의 인덱스 번호가 없을 때(ArrayIndexOutOfBoundsException)
		int[] arr= {1,2,3,4,5};
		
		try {
		for(int i=0;i<6;i++) {
			System.out.println("arr["+i+"]: "+arr[i]); // 예외가 발생할 코드
		}
